...
##################################################################
dcmp_fact_fix = dexp_comp000(dexp_fact_fix)
_ = print("dcmp_fact_fix = ", repr(dcmp_fact_fix))
##################################################################

the_nind = 0
dinslst_emit000(dcmp_fact_fix.inss, the_nind)

##################################################################
##################################################################
# end of [CS391-2026-Summer/lectures/lecture-06-09/lambda4_test.py]
##################################################################
##################################################################
